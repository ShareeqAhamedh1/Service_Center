            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Alerts</h1>
                            <div class="">
                                <nav>
...
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-warning alert-dismissible fade show" role="alert"&gt;
&lt;strong&gt;Holy guacamole!&lt;/strong&gt; You should check in on some of those fields
below.
&lt;button type="button" class="btn-close" data-bs-dismiss="alert"
    aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button>
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div id="liveAlertPlaceholder"&gt;
    &lt;div class="mb-2"&gt;&lt;/div&gt;
    &lt;div class="mb-2"&gt;&lt;/div&gt;
    &lt;div class="mb-2"&gt;&lt;/div&gt;
    &lt;div class="mb-2"&gt;&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-primary" role="alert"&gt;
    A simple primary alert—check it out!
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-solid-primary alert-dismissible fade show"&gt;
    A simple solid primary alert—check it out!
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-solid-primary shadow-sm alert-dismissible fade show"&gt;
    A simple solid primary alert with small shadow—check it out!
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-primary shadow-sm">A simple primary alert with small shadow—check it out!&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-solid-primary rounded-pill alert-dismissible fade show"&gt;
    A simple solid rounded primary alert—check it out!
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-outline-primary rounded-pill alert-dismissible fade show"&gt;
    A simple outline rounded primary alert—check it out!
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-primary rounded-pill alert-dismissible fade show"&gt;
    A simple rounded primary alert—check it out!
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-primary d-flex align-items-center" role="alert"&gt;
    &lt;svg class="flex-shrink-0 me-2 svg-primary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"&gt;&lt;path d="M0 0h24v24H0V0z" fill="none"/&gt;&lt;path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/&gt;&lt;/svg&gt;
    &lt;div&gt;
        An example alert with an icon
    &lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-primary alert-dismissible fade show custom-alert-icon shadow-sm" role="alert"&gt;
    &lt;svg class="svg-primary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"&gt;&lt;path d="M0 0h24v24H0z" fill="none"/&gt;&lt;path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/&gt;&lt;/svg&gt;
    A customized primary alert with an icon
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-img alert-primary alert-dismissible fase show rounded-pill flex-wrap" role="alert"&gt;
    &lt;div class="avatar avatar-sm me-3 avatar-rounded"&gt;
        &lt;img src="../assets/images/faces/3.jpg" alt="img"&gt;
    &lt;/div&gt;
    &lt;div&gt;A simple primary alert with image—check it out!&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="alert alert-img alert-primary alert-dismissible fase show flex-wrap" role="alert"&gt;
    &lt;div class="avatar avatar-xs me-3"&gt;
        &lt;img src="../assets/images/faces/3.jpg" alt="img"&gt;
    &lt;/div&gt;
    &lt;div&gt;A simple primary alert with image—check it out!&lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="col-xl-6"&gt;
    &lt;div class="alert alert-primary overflow-hidden p-0" role="alert"&gt;
        &lt;div class="p-3 bg-primary text-fixed-white d-flex justify-content-between"&gt;
            &lt;h6 class="aletr-heading mb-0"&gt;Thank you for reporting this.&lt;/h6&gt;
            &lt;button type="button" class="btn-close p-0 text-fixed-white" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
