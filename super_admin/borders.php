        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">Borders</h1>
                        <div class="">
                            <nav>
...
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="border border-container"&gt;&lt;/span&gt;
    &lt;span class="border-top border-container"&gt;&lt;/span&gt;
    &lt;span class="border-end border-container"&gt;&lt;/span&gt;
    &lt;span class="border-bottom border-container"&gt;&lt;/span&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="border-0 border-container"&gt;&lt;/span&gt;
    &lt;span class="border border-top-0 border-container"&gt;&lt;/span&gt;
    &lt;span class="border border-end-0 border-container"&gt;&lt;/span&gt;
    &lt;span class="border border-bottom-0 border-container"&gt;&lt;/span&gt;
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="border border-container border-1"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-2"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-3"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-4"&gt;&lt;/span&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-7">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="border border-container border-primary"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-secondary"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-success"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-danger"&gt;&lt;/span&gt;
    &lt;span class="border border-container border-warning"&gt;&lt;/span&gt;
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <div
                                    class="p-3 bg-info bg-opacity-10 border border-info border-start-0 rounded-end mb-1 text-dark">
                                    Customizing borders with backgrounud colors
                                </div>
                            </div>
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="mb-4"&gt;
    &lt;label for="exampleFormControlInput1" class="form-label"&gt;Email
        address&lt;/label&gt;
    &lt;input type="email" class="form-control border-success"
        id="exampleFormControlInput1" placeholder="name@example.com"&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="border border-success p-2 mb-2"&gt;This is default success border&lt;/div&gt;
    &lt;div class="border border-success p-2 mb-2 border-opacity-75"&gt;This is 75%
        opacity
        success border
    &lt;/div&gt;
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-top" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-end" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-bottom" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-start" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-circle" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img  rounded-pill" alt="...">
                            </div>
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-top" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-end" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-bottom" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-start" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img rounded-circle" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img  rounded-pill" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-0" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-1" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-2" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-3" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-4" alt="...">
                                <img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-5" alt="...">
                            </div>
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-0" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-1" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-2" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-3" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-4" alt="..."&gt;
    &lt;img src="../assets/images/media/28.jpg" class="bd-placeholder-img bd-placeholder-img rounded-5" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                            </div>
                        </div>
                    </div>
