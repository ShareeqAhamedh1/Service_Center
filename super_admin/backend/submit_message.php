...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO tbl_ticket_chat (tic_desc, tic_img, tic_file, tic_id, h_a_id, h_s_a_id, tic_msg_sender) 
            VALUES ('$message', '$photoFileName', '$attachmentFileName', '$tic_id', '$h_a_id', '$h_s_a_id', 1)";
    $rs = $conn->query($sql);

    // Update the ticket status
    $sqlStatus = "UPDATE tbl_tickets SET status = 1 WHERE tic_id = '$tic_id'";
