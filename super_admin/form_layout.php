            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Layout</h1>
                            <div class="">
                                <nav>
...
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="mb-3"&gt;
    &lt;label for="form-text" class="form-label fs-14 text-dark"&gt;Enter name&lt;/label&gt;
    &lt;input type="text" class="form-control" id="form-text" placeholder=""&gt;
&lt;/div&gt;
&lt;div class="mb-3"&gt;
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;form class="row row-cols-lg-auto g-3 align-items-center"&gt;
    &lt;div class="col-12"&gt;
        &lt;label class="visually-hidden"
            for="inlineFormInputGroupUsername"&gt;Username&lt;/label&gt;
        &lt;div class="input-group"&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="row g-3"&gt;
    &lt;div class="col-sm-7"&gt;
        &lt;input type="text" class="form-control" placeholder="City"
            aria-label="City"&gt;
    &lt;/div&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="row mb-3"&gt;
    &lt;label for="colFormLabelSm"
        class="col-sm-2 col-form-label col-form-label-sm"&gt;Email&lt;/label&gt;
    &lt;div class="col-sm-10"&gt;
        &lt;input type="email" class="form-control form-control-sm"
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;form class="row gy-2 gx-3 align-items-center mb-4"&gt;
    &lt;div class="col-auto"&gt;
        &lt;label class="visually-hidden" for="autoSizingInput"&gt;Name&lt;/label&gt;
        &lt;input type="text" class="form-control" id="autoSizingInput"
            placeholder="Jane Doe"&gt;
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="row"&gt;
    &lt;div class="col-md-6 mb-3"&gt;
        &lt;label class="form-label"&gt;First Name&lt;/label&gt;
        &lt;input type="text" class="form-control" placeholder="First name"
            aria-label="First name"&gt;
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;form class="row g-3 mt-0"&gt;
    &lt;div class="col-md-6"&gt;
        &lt;label class="form-label"&gt;First Name&lt;/label&gt;
        &lt;input type="text" class="form-control" placeholder="First name"
            aria-label="First name"&gt;
