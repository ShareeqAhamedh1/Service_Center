		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">Blog Post</h1>
				        <div class="">
				            <nav>
				...
				<div class="row">
					...
					<div class="col-xl-4">
						<div class="card custom-card recent-posts">
							...
							<div class="card-body">
								<div class="">
									<div class="d-sm-flex overflow-visible">
										<a href="blog-details.php" class="display-contents"> <img
											...
											<div class="ps-3 flex-column my-auto display-text-contents">
												...
												<h4 class="fs-18">Generator on the
														Internet..</h4>
