            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Cards</h1>
                            <div class="">
                                <nav>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/22.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/23.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/24.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-semibold">Card title</h6>
                                    <p class="card-text">Some quick example text to build on the card title and
                                        make up the bulk of the card's content.</p>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="../assets/images/media/25.jpg" class="card-img mb-3" alt="...">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="../assets/images/media/26.jpg" class="card-img mb-3" alt="...">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="../assets/images/media/2.jpg" class="card-img mb-3" alt="...">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="../assets/images/media/4.jpg" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="../assets/images/media/9.jpg" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="../assets/images/media/15.jpg" class="card-img mb-3" alt="...">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <img src="../assets/images/media/9.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="../assets/images/media/8.jpg" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="../assets/images/media/3.jpg" class="card-img rounded-0" alt="...">
                                <div class="card-body">
                                    <p class="card-text mb-0"><small>Last updated 3 mins
                                            ago</small></p>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="../assets/images/media/1.jpg" class="card-img rounded-0" alt="...">
                                <div class="card-footer">
                                    <p class="card-text mb-0"><small>Last updated 3 mins
                                            ago</small></p>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <img src="../assets/images/media/2.jpg" class="card-img-top" alt="...">
                                <div class="card-header">
                                    <div class="card-title">Image caps are widely used in Blog's</div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="../assets/images/media/3.jpg" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                    </div>
                    <!-- End::row-6 -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="../assets/images/media/4.jpg" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    <div class="card-header">
                                        <div class="card-title text-fixed-white">
                                            Image Overlays Are Awesome!
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="../assets/images/media/29.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="../assets/images/media/30.jpg" class="img-fluid rounded-end h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="../assets/images/media/31.jpg" class="img-fluid rounded-end h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card card-bg-pink">
                                <div class="card-body">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="me-2">
                                            <span class="avatar avatar-rounded">
                                        ...
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-fixed-white op-7 fs-12">Finished by 24,Nov</p>
                                        </div>
                                        <div class="ms-auto">
                                            <a href="javascript:void(0);" class="text-fixed-white"><i class="bi bi-three-dots-vertical"></i></a>
                                        </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card border border-warning custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-4">
                                        <span class="badge bg-warning-transparent">php</span>
                        ...
                        <div class="col-xl-3">
                            <div class="card border border-success custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-4">
                                        <span class="badge bg-danger-transparent">php</span>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-group">
                                <div class="card custom-card">
                                    <img src="../assets/images/media/4.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card custom-card">
                                    <img src="../assets/images/media/1.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="col-xxl-7 col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                <img src="../assets/images/media/9.jpg" class="img-fluid rounded-end h-100" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xxl-3 col-xl-6">
                            <div class="card custom-card">
                                <a href="javascript:void(0);" class="card-anchor"></a>
                                <img src="../assets/images/media/7.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row row-cols-1 row-cols-md-4 g-4">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="../assets/images/media/3.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="../assets/images/media/5.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
                                            <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                        </div>
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="../assets/images/media/6.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
