            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Helpers</h1>
                            <div class="">
                                <nav>
                    ...
                    <div class="row">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                                        <div class="card-header border-bottom-0 text-fixed-white">
                                            <div class="card-title">
                                                Header
                                            </div>
                                        </div>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="bd-placeholder-img card-img-top card-img" src="../assets/images/media/15.jpg" alt="...">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-evenly flex-wrap">
                                        <a href="#" class="link-primary fw-semibold fs-15 p-1">Primary</a>
                                        <a href="#" class="link-secondary fw-semibold fs-15 p-1">Secondary</a>
                                        <a href="#" class="link-success fw-semibold fs-15 p-1">Success</a>
                                        <a href="#" class="link-danger fw-semibold fs-15 p-1">Danger</a>
                                        <a href="#" class="link-warning fw-semibold fs-15 p-1">Warning</a>
                                        <a href="#" class="link-info fw-semibold fs-15 p-1">Info</a>
                                        <a href="#" class="link-light fw-semibold fs-15 p-1">Light</a>
                                        <a href="#" class="link-dark fw-semibold fs-15 p-1">Dark</a>
                                    </div>
                                </div>
                            </div>
                        </div>
