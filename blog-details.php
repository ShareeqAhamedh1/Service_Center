		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">Blog Details</h1>
				        <div class="">
				            <nav>
				...
				<div class="row">
					<div class="col-xl-8">
						<div class="card custom-card">
							<img class="card-img-top br-bl-0 br-br-0" src="../assets/images/media/27.jpg"
								alt="Card image cap">
							<div class="card-body">
								<div class="d-md-flex">
									<a href="javascript:void(0);" class="d-flex me-4 mb-2"><i
											class="fe fe-calendar fs-16 me-1 p-3 bg-secondary-transparent text-secondary rounded-3"></i>
										<div class="mt-0 mt-3 ms-1 text-muted font-weight-semibold">Sep-25-2021</div>
									</a>
									<a href="profile.php" class="d-flex mb-2"><i
											class="fe fe-user fs-16 me-1 p-3 bg-primary-transparent text-primary rounded-3"></i>
										<div class="mt-0 mt-3 ms-1 text-muted font-weight-semibold">Harry Fisher</div>
									</a>
									<div class="ms-auto">
										<a href="javascript:void(0);" class="d-flex mb-2"><i
												class="fe fe-message-square fs-16 me-1 p-3 bg-success-transparent text-success rounded-3"></i>
											<div class="mt-0 mt-3 ms-1 text-muted font-weight-semibold">13 Comments
											</div>
										</a>
									</div>
								</div>
						...
						<div class="card custom-card">
							...
							<div class="card-body pb-0">
								<div class="media mb-5 overflow-visible d-block d-sm-flex">
									<div class="me-3 mb-2">
										<a href="profile.php"> <img class="media-object rounded-circle thumb-sm"
												alt="64x64" src="../assets/images/faces/5.jpg"> </a>
									</div>
										...
										<div class="border mb-5 p-4 br-5">
											<nav class="nav float-end">
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-end z-0">
														<a class="dropdown-item" href="javascript:void(0)"><i
																class="fe fe-edit me-1 d-inline-flex"></i> Edit</a>
														<a class="dropdown-item" href="javascript:void(0)"><i
																class="fe fe-corner-up-left me-1 d-inline-flex"></i> Reply</a>
														<a class="dropdown-item" href="javascript:void(0)"><i
																class="fe fe-flag me-1 d-inline-flex"></i> Report Abuse</a>
														<a class="dropdown-item" href="javascript:void(0)"><i
																class="fe fe-trash-2 me-1 d-inline-flex"></i> Delete</a>
													</div>
												</div>
											</nav>
											<h5 class="mt-0">Florinda Carasco</h5>
											<span><i class="fe fe-thumb-up text-danger"></i></span>
											<p class="font-13 text-muted">Lorem ipsum dolor sit amet, quis Neque porro
											...
											<span class="reply" id="1">
												<a href="javascript:;"><span class="badge btn-primary p-2"><i
															class="fe fe-corner-up-left mx-1"></i>Reply</span></a>
											</span>
										</div>
										<div class="media mb-5 overflow-visible d-sm-flex d-block">
											<div class="me-3 mb-2">
												<a href="profile.php"> <img
														class="media-object rounded-circle thumb-sm" alt="64x64"
														src="../assets/images/faces/2.jpg"> </a>
											</div>
											<div class="media-body border p-4 overflow-visible br-5">
												...
												<a class="like" href="javascript:;"><span
														class="badge btn-danger p-2"><i
															class="fe fe-heart mx-1"></i>Like</span></a>
								...
								<div class="media mb-5 overflow-visible d-block d-sm-flex">
									<div class="me-3 mb-2">
										<a href="profile.php"> <img class="media-object rounded-circle thumb-sm"
												alt="64x64" src="../assets/images/faces/15.jpg"> </a>
									</div>
									<div class="media-body overflow-visible">
										<div class="border mb-5 p-4 br-5">
											<nav class="nav float-end">
											...
											<p class="font-13 text-muted">Very nice ! On the other hand, we denounce
												with righteous indignation and dislike men who are so beguiled and
												demoralized by the </p>
											<a class="like" href="javascript:;"><span class="badge btn-danger p-2"><i
														class="fe fe-heart mx-1"></i>Like</span></a>
											...
											<div class="media-body overflow-visible">
												...
												<div class="media overflow-visible d-block d-sm-flex">
													<div class="me-3 mb-2">
														<a href="profile.php"> <img
																class="media-object rounded-circle thumb-sm" alt="64x64"
																src="../assets/images/faces/9.jpg"> </a>
													</div>
													<div class="media-body border p-4 overflow-visible br-5">
														<nav class="nav float-end">
															<div class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-end z-0">
																	...
																	<a class="dropdown-item"
																		href="javascript:void(0)"><i
																			class="fe fe-corner-up-left me-1 d-inline-flex"></i>
																		Reply</a>
																	<a class="dropdown-item"
																		href="javascript:void(0)"><i
																			class="fe fe-flag me-1 d-inline-flex"></i> Report
																		Abuse</a>
																	<a class="dropdown-item"
																		href="javascript:void(0)"><i
																			class="fe fe-trash-2 me-1 d-inline-flex"></i> Delete</a>
					...
					<div class="col-xl-4">
						...
						<div class="card custom-card">
							...
							<div class="card-body">
								<ul class="list-group">
									<li class="list-group-item border list-icon rounded-bottom-0"><a
											href="javascript:void(0)" class="text-dark mx-3"> Business</a> <span
											class="product-label">11</span> </li>
									<li class="list-group-item border list-icon rounded-0 border-top-0"><a
											href="javascript:void(0)" class="text-dark mx-3"> Gadgets</a> <span
											class="product-label">46</span> </li>
									<li class="list-group-item border list-icon rounded-0 border-top-0"><a
											href="javascript:void(0)" class="text-dark mx-3"> Fashion</a> <span
											class="product-label">25</span> </li>
									<li class="list-group-item border list-icon rounded-top-0 border-top-0"><a
											href="javascript:void(0)" class="text-dark mx-3"> Political</a> <span
											class="product-label">73</span> </li>
								</ul>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="">
									<div class="d-flex overflow-visible">
										<img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/1.jpg"
											alt="avatar-img">
									...
									<div class="d-flex overflow-visible mt-4">
										<img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/3.jpg"
											alt="avatar-img">
										<div class="media-body valign-middle my-auto">
									...
									<div class="d-flex overflow-visible mt-4">
										<img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/5.jpg"
											alt="avatar-img">
										<div class="media-body valign-middle my-auto">
									...
									<div class="d-flex overflow-visible mt-4">
										<img class="avatar bradius avatar-xl me-3" src="../assets/images/faces/15.jpg"
											alt="avatar-img">
										<div class="media-body valign-middle my-auto">
						...
						<div class="card custom-card recent-posts">
							<div class="card-header">
								<div class="card-title">Recent Posts</div>
							</div>
							<div class="card-body">
								<div class="">
									<div class="d-sm-flex overflow-visible d-xl-block d-xxl-flex">
										<a href="blog-details.php" class="display-contents"> <img
												src="../assets/images/media/19.jpg" alt=""
												class="card-aside-column br-5 cover-image">
											<div class="ps-3 flex-column my-auto display-text-contents">
												<h4>Generator on the Internet..</h4>
												<div class="text-muted">Excepteur sint occaecat cupidatat non proident,
									...
									<div class="d-sm-flex overflow-visible d-xl-block d-xxl-flex mt-4">
										<a href="blog-details.php" class="display-contents"> <img
												src="../assets/images/media/20.jpg" alt=""
												class="card-aside-column br-5 cover-image">
											<div class="ps-3 flex-column my-auto display-text-contents">
									...
									<div class="d-sm-flex overflow-visible d-xl-block d-xxl-flex mt-4">
										<a href="blog-details.php" class="display-contents"> <img
												src="../assets/images/media/22.jpg" alt=""
												class="card-aside-column br-5 cover-image">
											<div class="ps-3 flex-column my-auto display-text-contents">
												<h4>Generator on the Internet..</h4>
												<div class="text-muted">Excepteur sint occaecat cupidatat non proident,
									...
									<div class="d-sm-flex overflow-visible d-xl-block d-xxl-flex mt-4">
										<a href="blog-details.php" class="display-contents"> <img
												src="../assets/images/media/23.jpg" alt=""
												class="card-aside-column br-5 cover-image">
											<div class="ps-3 flex-column my-auto display-text-contents">
												<h4>Generator on the Internet..</h4>
												<div class="text-muted">Excepteur sint occaecat cupidatat non proident,
