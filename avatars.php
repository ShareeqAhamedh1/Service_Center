        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">Avatars</h1>
                        <div class="">
                            <nav>
...
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar me-2 avatar-radius-0"&gt;
    &lt;img src="../assets/images/faces/1.jpg" alt="img"&gt;
&lt;/span&gt;
&lt;span class="avatar me-2"&gt;
    &lt;img src="../assets/images/faces/2.jpg" alt="img"&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar avatar-xs me-2"&gt;
    &lt;img src="../assets/images/faces/4.jpg" alt="img"&gt;
&lt;/span&gt;
&lt;span class="avatar avatar-sm me-2"&gt;
    &lt;img src="../assets/images/faces/5.jpg" alt="img"&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar avatar-xs me-2 avatar-rounded"&gt;
    &lt;img src="../assets/images/faces/2.jpg" alt="img"&gt;
    &lt;a href="javascript:void(0);" class="badge bg-success rounded-pill avatar-badge"&gt;&lt;i class="fe fe-camera"&gt;&lt;/i&gt;&lt;/a&gt;
&lt;/span&gt;
&lt;span class="avatar avatar-sm me-2 avatar-rounded"&gt;
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar avatar-xs me-2 online avatar-rounded"&gt;
    &lt;img src="../assets/images/faces/8.jpg" alt="img"&gt;
&lt;/span&gt;
&lt;span class="avatar avatar-sm online me-2 avatar-rounded"&gt;
    &lt;img src="../assets/images/faces/10.jpg" alt="img"&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar avatar-xs me-2 offline avatar-rounded"&gt;
    &lt;img src="../assets/images/faces/2.jpg" alt="img"&gt;
&lt;/span&gt;
&lt;span class="avatar avatar-sm offline me-2 avatar-rounded"&gt;
    &lt;img src="../assets/images/faces/3.jpg" alt="img"&gt;
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;span class="avatar avatar-xs me-2 bg-primary"&gt;
    xs
&lt;/span&gt;
...
<!-- Prism Code -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-php"><code class="language-php">&lt;div class="avatar-list-stacked"&gt;
    &lt;span class="avatar"&gt;
        &lt;img src="../assets/images/faces/2.jpg" alt="img"&gt;
    &lt;/span&gt;
    &lt;span class="avatar"&gt;
