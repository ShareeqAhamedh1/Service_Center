            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Blog</h1>
                            <div class="">
                                <nav>
					...
					<div class="col-md-4">
						<div class="card custom-card">
							...
							<div class="card-header">
								<a href="blog-details.php"><h5 class="card-title text-primary">Blog title </h5></a>
							</div>
							<div class="card-body">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								<a href="blog-details.php" class="float-end text-primary">Read more <i class="fa fa-angle-double-right"></i></a>
							</div>
						</div>
					</div>
					<!-- COL-END -->
						...
						<div class="card custom-card">
							...
							<div class="card-body d-flex flex-column">
								...
								<div class="d-flex align-items-center pt-5 mt-auto">
									<img class="avatar rounded-circle avatar-md me-3 cover-image" alt="img" src="../assets/images/faces/1.jpg">
									<div>
										<a href="profile.php" class="text-default">John Paige</a>
										<small class="d-block text-muted">1 days ago</small>
									</div>
									<div class="ms-auto text-muted">
										<a href="javascript:void(0)" class="icon d-none d-md-inline-block ms-3"><i class="ri-heart-line me-1 text-primary"></i></a>
										<a href="javascript:void(0)" class="icon d-none d-md-inline-block ms-3"><i class="ri-thumb-up-line text-primary"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card custom-card">
							...
							<div class="card-body d-flex flex-column">
								...
								<div class="d-flex align-items-center pt-5 mt-auto">
									<img class="avatar rounded-circle avatar-md me-3 cover-image" alt="img" src="../assets/images/faces/2.jpg">
									<div>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card custom-card">
							<div class="card-body d-flex flex-column">
								...
								<div class="d-flex align-items-center pt-5 mt-auto">
									<img class="avatar rounded-circle avatar-md me-3 cover-image" alt="img" src="../assets/images/faces/3.jpg">
									<div>
							...
							<a href="blog-details.php"><img class="card-img-top br-tr-0 br-tl-0 br-5 rounded-top-0" src="../assets/images/media/15.jpg" alt="How do you know she is a witch?"></a>
						</div>
					</div>
					<!-- COL-END -->
					<div class="col-sm-6 col-xl-3">
						<div class="card custom-card">
							<div class="card-body d-flex flex-column">
								...
								<div class="d-flex align-items-center pt-5 mt-auto">
									<img class="avatar rounded-circle avatar-md me-3 cover-image" alt="img" src="../assets/images/faces/4.jpg">
									<div>
							...
							<a href="blog-details.php"><img class="card-img-top br-tr-0 br-tl-0 br-5 rounded-top-0" src="../assets/images/media/16.jpg" alt="Shut up!"></a>
						</div>
					</div>
				</div>
				<!-- ROW-1 CLOSED -->
